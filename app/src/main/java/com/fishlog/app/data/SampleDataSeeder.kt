    ...
    suspend fun seed(catchLogDao: CatchLogDao, fishingTripDao: FishingTripDao): String {
        ...
        for (i in 1..36) {
            ...
            val tripId = fishingTripDao.insertTrip(FishingTrip(
                ...
                airTempF = getSeasonalTemp(season, timeOfDay, random),
                ...
                humidityPercent = random.nextDouble(30.0, 90.0),
                windSpeedMph = random.nextDouble(0.0, 20.0),
                windDirectionDegrees = random.nextDouble(0.0, 360.0),
                barometricPressureHpa = random.nextDouble(1000.0, 1025.0),
                cloudCoverPercent = random.nextDouble(0.0, 100.0),
                moonAutoFilled = true,
